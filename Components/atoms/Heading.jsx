...
const Heading = ({ level, children, className }) => {
  ...
  const getHeadingStyles = (level) => {
    switch (level) {
      case 1:
        return `xl:text-[30px] md:text-[20px] sm:text-[15px]  xl:font-[700] lg:font-[700] md:font-[700] sm:font-[600] font-[600] xl:leading-[70px] lg:leading-[60px] md:leading-[60px] sm:leading-[50px] leading-[40px] tracking-[-2px] ${className}`;
      case 2:
